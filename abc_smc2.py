...
x_data= model_equation.x_data
y_data= model_equation.y_data
max_input= model_equation.max_input
...
#here
                ...
                d = model_equation.distance(p,x_data,y_data,max_input)
...
#final_dist =100
def Sequential_ABC(x_data,y_data,max_input, ncpus,
...
def main(argv):
  ...
  if os.path.isdir(version) is False:
      print("wrong version")
      sys.exit(1)
  print("Passed options: version = ", version)
