...
### For instance for a repressive hill function:
    ...
    node2_sg1 = p['leak_1']+(max_input['sg1']-p['leak_1'])/(1+np.power(node1/10**p['log_k_1'],p['n_sg'])) 
    node2_sg1t4 = p['leak_1t4']+(max_input['sg1t4']-p['leak_1t4'])/(1+np.power(node1/10**p['log_k_1t4'],p['n_sg'])) 
    node2_sg2 = p['leak_2']+(max_input['sg2']-p['leak_2'])/(1+np.power(node1/10**p['log_k_2'],p['n_sg'])) 
    node2_sg3 = p['leak_3']+(max_input['sg3']-p['leak_3'])/(1+np.power(node1/10**p['log_k_3'],p['n_sg'])) 
    node2_sg4 = p['leak_4']+(max_input['sg4']-p['leak_4'])/(1+np.power(node1/10**p['log_k_4'],p['n_sg'])) 
    node2_sg4t4 = p['leak_4t4']+(max_input['sg4t4']-p['leak_4t4'])/(1+np.power(node1/10**p['log_k_4t4'],p['n_sg'])) 
    node2_sg5 = p['leak_5']+(max_input['sg5']-p['leak_5'])/(1+np.power(node1/10**p['log_k_5'],p['n_sg'])) 
    node2_sg6 = p['leak_6']+(max_input['sg6']-p['leak_6'])/(1+np.power(node1/10**p['log_k_6'],p['n_sg'])) 
